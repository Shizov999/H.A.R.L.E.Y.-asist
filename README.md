...
## Дорожная карта (идеи)
- Настраиваемый wake‑word детектор (VAD + keyword spotting).
- Кастомизация голосов/скорости из интерфейса.
- Плагины действий (открытый каталог команд).
- Портирование на Linux/macOS (альтернативы SAPI/pycaw).
